...
# Writes the aggregate CSV named by $1, plus one detail CSV per date scored
# beside it, named with that date before the extension.
...
update_feature_level_interop_csv out/data/stable-browser-feature-interop-exclusions.csv
update_feature_level_interop_csv out/data/experimental-browser-feature-interop-exclusions.csv
